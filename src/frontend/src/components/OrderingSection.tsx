...
const orderMenuData: Record<string, OrderDish[]> = {
  appetizers: [
    ...
    },
    {
      ...
      price: 196,
      gradient: "from-lime-900/70 to-green-800/60",
      badge: "Veg",
    },
    {
      ...
      price: 180,
      gradient: "from-amber-800/70 to-orange-800/60",
      badge: "Veg",
    },
    {
      name: "Dahi Ke Kabab",
    ...
    },
    {
      ...
      price: 196,
      gradient: "from-yellow-800/60 to-amber-700/50",
      badge: "Veg",
    },
    {
      ...
      price: 239,
      gradient: "from-stone-800/70 to-amber-800/60",
      badge: "Veg",
    },
    {
      ...
      price: 249,
      gradient: "from-amber-700/70 to-orange-700/60",
      badge: "Veg",
    },
    {
      ...
      price: 179,
      gradient: "from-yellow-700/70 to-lime-700/60",
      badge: "Veg",
    },
    {
      ...
      price: 369,
      gradient: "from-green-900/70 to-amber-800/60",
      badge: "Platter",
    },
    {
      ...
      price: 299,
      gradient: "from-red-900/70 to-orange-800/60",
      badge: "Non-Veg",
    },
    {
      ...
      price: 290,
      gradient: "from-orange-900/70 to-red-800/60",
      badge: "Non-Veg",
    },
    {
      ...
      price: 295,
      gradient: "from-yellow-800/70 to-orange-700/60",
      badge: "Non-Veg",
    },
    {
      ...
      price: 280,
      gradient: "from-amber-800/60 to-yellow-700/50",
      badge: "Non-Veg",
    },
    {
    ...
    },
    {
      ...
      price: 239,
      gradient: "from-stone-800/70 to-amber-900/60",
      badge: "Non-Veg",
    },
    {
      name: "Mutton Seekh",
      ...
      price: 279,
      gradient: "from-red-900/70 to-stone-800/60",
      badge: "Non-Veg",
    },
    {
    ...
    },
    {
      ...
      price: 299,
      gradient: "from-red-900/60 to-orange-800/50",
      badge: "Non-Veg",
    },
    {
      ...
      price: 279,
      gradient: "from-amber-900/70 to-stone-800/60",
      badge: "Non-Veg",
    },
    {
      ...
      price: 309,
      gradient: "from-red-800/70 to-orange-800/60",
      badge: "Non-Veg",
    },
    {
      name: "Tandoori Fish",
      description:
        "Fish marinated in tandoori spices and grilled in clay oven.",
      price: 309,
      gradient: "from-teal-900/70 to-cyan-800/60",
      badge: "Seafood",
    },
    {
      name: "Fish Lahsani",
      description: "Garlic-marinated fish fillet grilled in tandoor.",
      price: 329,
      gradient: "from-blue-900/60 to-teal-800/50",
      badge: "Seafood",
    },
  ],
  soup: [
    ...
    },
    {
      ...
      price: 59,
      gradient: "from-red-900/60 to-amber-800/50",
    },
    {
      name: "Tomato Soup",
      description: "Fresh tomato soup with cream and croutons.",
      price: 69,
      gradient: "from-red-800/70 to-orange-700/60",
    },
  ],
  breakfast: [
    {
    ...
    },
    {
      ...
      price: 96,
      gradient: "from-stone-700/70 to-amber-700/60",
    },
    {
      name: "Pyaaz Parantha",
      description: "Onion stuffed paratha, crispy on tawa with desi ghee.",
      price: 69,
      gradient: "from-lime-900/60 to-green-800/50",
    },
    {
      name: "Chole Bhature",
      description:
    ...
    },
    {
      ...
      price: 79,
      gradient: "from-yellow-800/60 to-orange-700/50",
    },
    {
      name: "Veg Pakora",
    ...
    },
    {
      ...
      price: 109,
      gradient: "from-orange-800/60 to-amber-700/50",
    },
  ],
  mainveg: [
    {
      name: "Dal Fry",
      description:
        "Gabbar ki Maa ki Dal – tempered yellow lentils with garlic & cumin.",
      price: 169,
      gradient: "from-yellow-800/70 to-amber-700/60",
    },
    {
      name: "Dal Tadka",
      description: "Tadka-tempered lentils with whole spices and ghee.",
      price: 179,
      gradient: "from-amber-800/70 to-orange-700/60",
    },
    {
      name: "Dal Makhani",
      description: "Black urad dal slow-cooked, finished with cream & butter.",
      price: 219,
    ...
    },
    {
      name: "Diwani Handi",
      description:
        "Mausi ki Rasoi – steamed mixed vegetables in thick creamy gravy.",
      price: 229,
      gradient: "from-green-900/60 to-teal-800/50",
    },
    {
      name: "Mix Veg",
      description: "Assortment of mixed vegetables tossed in select spices.",
      price: 219,
      gradient: "from-lime-900/60 to-green-800/50",
      badge: "Veg",
    },
    {
      ...
      description:
        "Kalia ka Especial – potatoes and cauliflower with Indian spices.",
      price: 199,
      gradient: "from-yellow-800/60 to-lime-800/50",
      badge: "Veg",
    },
    {
      name: "Kashmiri Dum Aloo",
      description:
        "Basanti ki Kadhai – mildly spiced potatoes in yoghurt-tomato base gravy.",
      price: 219,
      gradient: "from-red-900/60 to-amber-800/50",
    },
    {
      name: "Jeera Aloo",
      description:
        "Banjara Special – boiled potatoes stir fried in roasted cumin.",
      price: 189,
      gradient: "from-amber-700/60 to-yellow-700/50",
    },
    {
      name: "Malai Kofta",
      description:
        "Sambha Ne Maanga – potato and cottage cheese dumplings in cashew poppy seed gravy.",
      price: 249,
      gradient: "from-orange-800/60 to-amber-700/50",
      badge: "Signature",
    },
    {
      name: "Pindi Chole",
      description:
        "Radha ki Rasoi – white chickpeas with fresh spices, onions and tomatoes.",
      price: 230,
      gradient: "from-amber-900/70 to-stone-800/60",
    },
    {
      ...
      description:
        "Mausi ka Bana – cashews and milk powder gravy, smooth and slightly sweet.",
      price: 179,
      gradient: "from-green-800/60 to-emerald-700/50",
      badge: "Veg",
    },
    {
      name: "Palak Corn",
      description:
        "Ramlal ke Haath ka – spinach and corn in fresh spiced gravy.",
      price: 209,
      gradient: "from-green-900/60 to-lime-800/50",
    },
    {
      name: "Palak Baby Corn",
      description: "Ramlal ke Haath ka – spinach and baby corn masala.",
      price: 219,
      gradient: "from-green-800/70 to-teal-700/60",
    },
    {
      name: "Tawa Masala Soya Chaap",
      description: "Ramgrah ke Tawe ke Chaap – tawa masala soya chaap.",
      price: 219,
      gradient: "from-orange-900/60 to-red-800/50",
    },
    {
      name: "Kadhai Soya Chaap",
      description:
        "Soya chaap cooked in kadhai with onions, tomatoes & spices.",
      price: 209,
      gradient: "from-red-900/60 to-orange-800/50",
    },
    {
      name: "Butter Masala Chaap",
      description: "Soya chaap in rich butter masala gravy.",
      price: 229,
      gradient: "from-amber-800/70 to-orange-700/60",
    },
    {
      ...
      description:
        "Kitne Mushroom The – mushrooms cooked with double onion masala.",
      price: 209,
      gradient: "from-stone-800/60 to-amber-700/50",
    },
    {
      name: "Kadhai Mushroom",
      description: "Mushrooms tossed in kadhai masala with peppers.",
      price: 229,
      gradient: "from-stone-700/70 to-amber-800/60",
    },
    {
      name: "Tawa Mushroom",
      description: "Mushrooms stir-fried on tawa with Indian spices.",
      price: 199,
      gradient: "from-stone-700/60 to-amber-700/50",
    },
    {
      name: "Mushroom Masala",
      description: "Mushrooms in spiced onion-tomato masala gravy.",
      price: 219,
      gradient: "from-amber-800/60 to-stone-700/50",
    },
    {
      name: "Palak Mushroom",
      description: "Mushrooms cooked in fresh spinach puree.",
      price: 199,
      gradient: "from-green-800/60 to-stone-700/50",
    },
    {
      name: "Matar Paneer",
      description:
        "Ramgarh ke Dhaabe se – green peas and paneer in masala gravy.",
      price: 179,
      gradient: "from-green-900/60 to-amber-700/50",
    },
    {
      name: "Paneer Butter Masala",
      description: "Cottage cheese in rich buttery tomato sauce.",
      price: 219,
      gradient: "from-orange-800/70 to-amber-700/60",
      badge: "Bestseller",
    },
    {
      name: "Palak Paneer",
      description: "Creamy spinach puree with paneer cubes.",
      price: 219,
      gradient: "from-green-900/70 to-lime-800/60",
    },
    {
      name: "Tawa Paneer",
      description: "Paneer tossed on tawa with peppers and spices.",
      price: 219,
      gradient: "from-amber-700/70 to-orange-600/60",
    },
    {
      name: "Paneer Bhurji",
      description: "Scrambled cottage cheese with onions, tomatoes and spices.",
      price: 229,
      gradient: "from-yellow-800/60 to-amber-700/50",
    },
    {
      name: "Paneer Do Pyaaza",
      description: "Paneer with double onion masala.",
      price: 229,
      gradient: "from-amber-900/60 to-orange-800/50",
    },
    {
      name: "Kadhai Paneer",
      description: "Paneer cooked in kadhai with peppers and whole spices.",
      price: 229,
      gradient: "from-red-900/60 to-amber-800/50",
    },
    {
      name: "Paneer Lababdar",
      description: "Paneer in smoky, rich makhani-style gravy.",
      price: 219,
      gradient: "from-orange-900/70 to-amber-800/60",
      badge: "Signature",
    },
    {
      ...
      description: "Paneer in coriander and ginger flavoured gravy.",
      price: 229,
      gradient: "from-green-800/60 to-amber-700/50",
    },
    {
      name: "Shahi Paneer",
      description: "Cottage cheese in rich saffron-cream mughlai gravy.",
      price: 239,
      gradient: "from-amber-900/70 to-yellow-800/60",
      badge: "Mughlai",
    },
    {
      name: "Paneer Methi Malai Matar",
      description: "Paneer with fenugreek and peas in malai gravy.",
      price: 269,
      gradient: "from-green-900/60 to-amber-800/50",
    },
  ],
  mainnonveg: [
    {
      name: "Murg Makhani (Regular)",
      description:
        "Sambha ka Phavorite – Kukkad – tender chicken in velvety tomato-butter sauce.",
      price: 299,
      image: "/assets/generated/butter-chicken.dim_600x400.jpg",
      badge: "Bestseller",
    },
    {
      name: "Murg Makhani (Boneless)",
      description:
        "Boneless tender chicken pieces in velvety tomato-butter cream sauce.",
      price: 309,
      gradient: "from-orange-900/70 to-amber-800/60",
    },
    {
      name: "Chicken Lal Pyaaz",
      description: "Chicken cooked with whole red onions and special spices.",
      price: 279,
      gradient: "from-red-900/60 to-orange-800/50",
    },
    {
      name: "Murg Dhania Adraki",
      description: "Chicken in coriander and ginger flavoured masala.",
      price: 289,
      gradient: "from-green-900/60 to-amber-700/50",
    },
    {
      name: "Murg Lababdar",
      description: "Chicken in rich makhani-style smoky gravy.",
      price: 369,
      gradient: "from-orange-900/70 to-red-800/60",
      badge: "Signature",
    },
    {
      name: "Chicken Curry",
      description:
        "Classic chicken curry with whole spices and thick onion-tomato base.",
      price: 269,
      gradient: "from-amber-900/60 to-orange-800/50",
    },
    {
      name: "Murg Kaali Mirch",
      description: "Chicken cooked in robust black pepper sauce.",
      price: 390,
      gradient: "from-stone-900/70 to-amber-800/60",
    },
    {
      name: "Matki Murg",
      description: "Chicken cooked in a clay pot with select spices.",
      price: 399,
      gradient: "from-amber-900/70 to-stone-800/60",
    },
    {
      name: "Murg Rara",
      description:
        "Double chicken – boneless and bone-in cooked together in spiced gravy.",
      price: 339,
      gradient: "from-red-900/70 to-orange-800/60",
      badge: "Chef's Pick",
    },
    {
      name: "Kabuli Chicken",
      description: "Chicken in creamy white gravy with whole spices.",
      price: 390,
      gradient: "from-amber-700/60 to-yellow-700/50",
    },
    {
      name: "Saag Chicken",
      description: "Chicken cooked in fresh mustard and spinach greens.",
      price: 320,
      gradient: "from-green-900/60 to-amber-700/50",
    },
    {
      name: "Patiala Chicken",
      description: "Rich Patiala-style chicken in thick onion gravy.",
      price: 340,
      gradient: "from-red-800/70 to-orange-700/60",
    },
    {
      name: "Kadhai Chicken",
      description:
        "Chicken tossed in kadhai with peppers, onions and whole spices.",
      price: 290,
      gradient: "from-orange-900/60 to-red-800/50",
    },
    {
      name: "Handi Chicken",
      description: "Slow-cooked chicken dum in a sealed clay handi.",
      price: 349,
      gradient: "from-stone-800/70 to-amber-800/60",
    },
    {
      name: "Murg Methi Chicken",
      description: "Chicken cooked with fresh fenugreek leaves.",
      price: 320,
      gradient: "from-green-800/60 to-amber-700/50",
    },
    {
      name: "Bhuna Chicken",
      description: "Chicken bhuna – dry roasted with strong spices.",
      price: 289,
      gradient: "from-red-900/70 to-stone-800/60",
    },
    {
      name: "Tawa Chicken",
      description: "Chicken stir-fried on tawa with onions and spices.",
      price: 319,
      gradient: "from-amber-800/60 to-orange-700/50",
    },
    {
      name: "Chicken Do Pyaaza",
      description: "Chicken with double onion masala.",
      price: 299,
      gradient: "from-orange-800/60 to-amber-700/50",
    },
    {
      name: "Egg Curry (Ramgarh Special)",
      description: "Whole fried eggs cooked in masala gravy.",
      price: 169,
      gradient: "from-yellow-800/60 to-amber-700/50",
    },
    {
      name: "Egg Bhurji",
      description: "Thakur ki Haveli Ka – whole fried eggs in masala gravy.",
      price: 199,
      gradient: "from-yellow-700/70 to-orange-700/60",
    },
    {
      name: "Tawa Mutton Seekh Masala",
      description:
        "Ek Ek Ko Chun Chun Ke Khaunga – mutton seekh in tawa masala.",
      price: 309,
      gradient: "from-red-900/70 to-stone-800/60",
      badge: "Non-Veg",
    },
    ...
    {
      name: "Bhuna Keema Kaleji",
      description: "Bhuna mutton mince with liver.",
      price: 279,
      gradient: "from-stone-900/70 to-red-800/60",
    },
    {
      name: "Mutton Rara Punjabi",
      description:
        "Double mutton – boneless and bone-in cooked in spiced Punjabi gravy.",
      price: 399,
      gradient: "from-red-900/70 to-amber-800/60",
      badge: "Signature",
    },
    {
      name: "Bhuna Gosht",
      description: "Mutton dry-roasted with strong whole spices.",
      price: 389,
      gradient: "from-stone-900/60 to-red-800/50",
    },
    {
      name: "Rogani Mutton",
      description: "Mutton in Kashmiri chilli-based aromatic rogani gravy.",
      price: 389,
      gradient: "from-red-950/80 to-rose-900/60",
      badge: "Kashmiri",
    },
    {
      name: "Mutton Nihari",
      description: "Slow-cooked mutton shank in rich spiced nihari gravy.",
      price: 389,
      gradient: "from-amber-900/70 to-red-900/60",
      badge: "Mughlai",
    },
    {
      name: "Tawa Mutton Saagwala",
      description: "Mutton cooked with greens on tawa.",
      price: 399,
      gradient: "from-green-900/60 to-red-800/50",
    },
    {
      name: "Kadhai Mutton",
      description: "Mutton tossed in kadhai with whole spices and peppers.",
      price: 389,
      gradient: "from-orange-900/60 to-red-800/50",
    },
    {
      name: "Fish Curry",
      description: "Tera Kya Hoga Re Macchi – fish in tangy curry gravy.",
      price: 299,
      gradient: "from-teal-900/70 to-cyan-800/60",
      badge: "Seafood",
    },
    {
      name: "Tomato Fish",
      description: "Fish cooked in fresh tomato masala.",
      price: 289,
      gradient: "from-red-800/60 to-teal-800/50",
      badge: "Seafood",
    },
    {
      name: "Fish Masala",
      description: "Fish in rich spiced masala gravy.",
      price: 309,
      gradient: "from-blue-900/60 to-teal-700/50",
      badge: "Seafood",
    },
  ],
  biryanirice: [
    {
      ...
      price: 99,
      gradient: "from-amber-700/50 to-yellow-600/40",
    },
    {
      name: "Rice Jeera",
    ...
    },
    {
      ...
      price: 179,
      gradient: "from-orange-900/60 to-amber-700/50",
    },
    {
  ...
  breads: [
    {
      name: "Tandoori Roti",
      description:
        "Soorma Bhopal ki chakki se – whole wheat roti from the tandoor.",
      price: 21,
      gradient: "from-amber-800/60 to-yellow-700/50",
    },
    {
      ...
      price: 26,
      gradient: "from-yellow-800/60 to-amber-600/50",
    },
    {
      name: "Plain Naan",
      description: "Soft leavened naan baked in tandoor.",
      price: 39,
      gradient: "from-amber-700/60 to-yellow-600/50",
    },
    {
      name: "Butter Naan",
      description: "Pillowy naan baked in tandoor and brushed with butter.",
      price: 45,
    ...
    },
    {
      ...
      description: "Flaky multi-layered whole-wheat paratha with desi ghee.",
      price: 36,
      gradient: "from-yellow-700/70 to-amber-600/60",
    },
    {
      name: "Green Chilli Parantha",
      description: "Paratha with fresh green chilli.",
      price: 39,
      gradient: "from-green-800/60 to-amber-700/50",
    },
    {
      name: "Pudhina Parantha",
      description: "Fresh mint-flavoured whole wheat paratha.",
      price: 39,
      gradient: "from-green-700/60 to-lime-700/50",
    },
    {
      name: "Ajwaini Parantha",
      description: "Paratha flavoured with ajwain seeds.",
      price: 45,
      gradient: "from-amber-700/60 to-stone-600/50",
    },
    {
      name: "Garlic Naan",
      description: "Naan baked in tandoor with garlic and butter.",
      price: 49,
      gradient: "from-amber-800/70 to-yellow-700/60",
    },
    {
      name: "Green Chilli Naan",
      description: "Naan with fresh green chilli baked in tandoor.",
      price: 45,
      gradient: "from-green-900/60 to-amber-700/50",
    },
    {
      name: "Missi Roti",
      description: "Gram flour and whole wheat mixed roti.",
      price: 36,
      gradient: "from-stone-700/60 to-amber-600/50",
    },
    {
      name: "Aloo Pyaz Kulcha",
      description: "Leavened bread stuffed with potato and onion.",
      price: 49,
      gradient: "from-amber-700/70 to-orange-600/60",
    },
    {
      name: "Mutton Keema Kulcha",
      description: "Kulcha stuffed with spiced mutton mince.",
      price: 99,
      gradient: "from-red-900/60 to-amber-800/50",
      badge: "Non-Veg",
    },
    {
      ...
      description: "Naan stuffed with spiced chicken mince.",
      price: 79,
      gradient: "from-orange-900/60 to-red-800/50",
      badge: "Non-Veg",
    },
    {
      ...
      description: "Kulcha stuffed with butter chicken filling.",
      price: 109,
      gradient: "from-orange-800/70 to-amber-700/60",
      badge: "Non-Veg",
    },
  ...
  chinese: [
    ...
    },
    {
      ...
      price: 109,
      gradient: "from-red-800/60 to-orange-700/50",
    },
    {
      name: "Veg Noodles",
    ...
    },
    {
      ...
      price: 179,
      gradient: "from-amber-900/60 to-orange-700/50",
    },
    {
      name: "Corn Salt & Pepper",
      description: "Baby corn tossed in salt and pepper.",
      price: 199,
      gradient: "from-yellow-800/60 to-lime-700/50",
    },
    {
    ...
    },
    {
      ...
      price: 179,
      gradient: "from-green-900/60 to-stone-700/50",
    },
    {
    ...
    },
    {
      ...
      price: 209,
      gradient: "from-amber-700/60 to-orange-600/50",
    },
    {
      name: "Chilli Chaap",
      description: "Soya chaap in spicy chilli sauce.",
      price: 179,
      gradient: "from-red-900/60 to-orange-700/50",
    },
    {
    ...
    },
    {
      ...
      price: 209,
      gradient: "from-red-800/60 to-amber-700/50",
    },
    {
      name: "Egg Fried Rice",
    ...
    },
    {
      ...
      price: 149,
      gradient: "from-yellow-700/60 to-stone-600/50",
    },
    {
      name: "Chicken Garlic Noodle",
      description: "Noodles with chicken in garlic sauce.",
      price: 169,
      gradient: "from-amber-800/60 to-red-700/50",
      badge: "Non-Veg",
    },
    {
    ...
    },
    {
      ...
      price: 199,
      gradient: "from-amber-900/60 to-red-700/50",
      badge: "Non-Veg",
    },
    {
      ...
      price: 249,
      gradient: "from-stone-800/60 to-red-700/50",
      badge: "Non-Veg",
    },
    {
    ...
    },
    {
      ...
      price: 299,
      gradient: "from-red-800/70 to-stone-700/60",
      badge: "Non-Veg",
    },
    {
      ...
      price: 249,
      gradient: "from-green-900/60 to-red-700/50",
      badge: "Non-Veg",
    },
    {
      name: "Meat Balls",
    ...
    {
      name: "Fish Chilli",
      description: "Crispy fish in Indo-Chinese chilli sauce.",
      price: 269,
      gradient: "from-teal-800/60 to-red-700/50",
      badge: "Seafood",
    },
    {
      name: "Fish Fried",
      description: "Golden deep-fried fish.",
      price: 279,
      gradient: "from-teal-900/60 to-amber-700/50",
      badge: "Seafood",
    },
    {
      name: "Fish Amritsari",
      description: "Amritsari-style battered fried fish.",
      price: 279,
      gradient: "from-amber-800/60 to-teal-700/50",
      badge: "Seafood",
    },
    {
      name: "Fish Fingers",
      description: "Crispy battered fish fingers.",
      price: 289,
      gradient: "from-blue-900/60 to-teal-700/50",
      badge: "Seafood",
    },
  ...
  sandwichespizza: [
    ...
    },
    {
      ...
      price: 129,
      gradient: "from-red-900/60 to-amber-700/50",
      badge: "Special",
    },
    {
      ...
      price: 139,
      gradient: "from-orange-800/60 to-red-700/50",
      badge: "Non-Veg",
    },
    {
      ...
      price: 69,
      gradient: "from-yellow-700/60 to-amber-600/50",
      badge: "Veg",
    },
    {
    ...
    },
    {
      ...
      price: 189,
      gradient: "from-red-800/60 to-yellow-700/50",
      badge: "Veg",
    },
    {
      name: "American Pizza",
    ...
    },
    {
      ...
      price: 229,
      gradient: "from-orange-900/60 to-red-700/50",
      badge: "Non-Veg",
    },
    {
    ...
    },
    {
      ...
      price: 249,
      gradient: "from-red-900/70 to-stone-700/60",
      badge: "Special",
    },
  ],
  rolls: [
    ...
    },
    {
      ...
      price: 109,
      gradient: "from-yellow-800/60 to-stone-600/50",
    },
    {
    ...
    },
    {
      ...
      price: 179,
      gradient: "from-red-900/70 to-orange-700/60",
      badge: "Non-Veg",
    },
  ],
  pasta: [
  ...
  raita: [
    {
      ...
      price: 59,
      gradient: "from-yellow-700/50 to-amber-600/40",
    },
    {
      name: "Boondi Raita",
    ...
    },
    {
      ...
      price: 79,
      gradient: "from-green-800/50 to-amber-600/40",
    },
    {
      name: "Pineapple Raita",
      description: "Sweet and tangy pineapple raita.",
      price: 89,
      gradient: "from-yellow-700/60 to-lime-600/50",
    },
    {
      name: "Veg Thali",
      description:
    ...
    },
    {
      ...
      price: 239,
      gradient: "from-amber-900/60 to-green-700/50",
      badge: "Thali",
    },
    {
      name: "Non Veg Thali",
  ...
  sweets: [
    {
      name: "Gulab Jamun",
      description:
        "Holi ka Jashan – soft milk solid balls soaked in rose-saffron syrup.",
      price: 45,
    ...
    },
    {
      ...
      description: "Bahut Garmi Hai – chocolate ice cream scoop.",
      price: 60,
      gradient: "from-stone-900/70 to-amber-800/60",
    },
    {
    ...
    },
    {
      ...
      description: "Strawberry ice cream scoop.",
      price: 60,
      gradient: "from-pink-800/60 to-rose-700/50",
    },
    {
      name: "Ice Cream – Butter Scotch",
      description: "Butter scotch with fruit & nut ice cream.",
      price: 80,
      gradient: "from-amber-700/70 to-yellow-600/60",
      badge: "Popular",
    },
    {
      name: "Roasted Papad",
      description: "Bhare Glass ke Saath – roasted papad.",
      price: 19,
      gradient: "from-amber-700/50 to-yellow-600/40",
    },
    {
      name: "Fried Papad",
      description: "Crispy deep-fried papad.",
      price: 19,
      gradient: "from-yellow-700/50 to-amber-600/40",
    },
    {
      ...
      price: 49,
      gradient: "from-lime-800/50 to-amber-700/40",
    },
  ],
  beverages: [
    {
      name: "Fresh Lime Soda",
      description: "Mehbooba 'O' Mehbooba – chilled fresh lime soda.",
      price: 59,
      gradient: "from-lime-800/60 to-green-700/50",
    },
    {
      name: "Lemon Iced Tea",
    ...
    },
    {
      ...
      price: 79,
      gradient: "from-stone-800/70 to-amber-700/60",
    },
    {
      name: "Hot Coffee",
      description: "Fresh hot coffee.",
      price: 39,
      gradient: "from-stone-900/60 to-amber-800/50",
    },
    {
      name: "Chocolate Shake",
      description: "Thick chocolate milkshake.",
      price: 89,
      gradient: "from-stone-900/70 to-amber-700/60",
    },
    {
    ...
    },
    {
      ...
      description: "Chilled cold drink with masala.",
      price: 49,
      gradient: "from-amber-700/60 to-orange-600/50",
    },
    {
      ...
      price: 45,
      gradient: "from-blue-800/50 to-cyan-700/40",
    },
    {
      name: "Cold Drink (750ml)",
      description: "Cold drink 750ml.",
      price: 45,
      gradient: "from-blue-900/50 to-cyan-800/40",
    },
  ],
};
...
const categoryLabels: Record<string, string> = {
  ...
  mainnonveg: "Main Course (Non-Veg)",
